...
import { KnowledgeSource,SourceStatus,SourceType } from "@/@types/types";
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetContent className="w-full sm:max-w-md  border-white/10 bg-black ">
        <div className="h-full flex flex-col">
          ...
          <Button variant={"destructive"} className="w-full bg-red-500/10 text-red-500 hover:bg-red-600/20">
            Disconnect Source 
          </Button>
