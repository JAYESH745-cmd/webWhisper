...
const Navbar =async  () => {
  ...
  {user ? (
      <div className="flex items-center gap-3">
        <Link
          href="/dashboard"
          className="h-10 px-4 rounded-xl bg-white text-black text-sm font-medium flex items-center justify-center hover:bg-zinc-200 transition"
        >
          Dashboard
        </Link>
      </div>
      ...
      <>
        ...
        <Link
          href="/api/auth"
          className="h-10 px-4 rounded-xl bg-white text-black text-xs font-medium flex items-center justify-center hover:bg-zinc-200 transition"
        >
          Get started
        </Link>
      </>
